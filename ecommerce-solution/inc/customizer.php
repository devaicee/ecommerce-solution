...
function ecommerce_solution_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting( 'ecommerce_solution_meta_seperator', array(
		'default'   => '',
		'sanitize_callback'	=> 'sanitize_text_field'
	) );
	$wp_customize->add_control( 'ecommerce_solution_meta_seperator', array(
		...
		'type'        => 'text',
		'settings'    => 'ecommerce_solution_meta_seperator',
	) );
	...
	$wp_customize->add_section('ecommerce_solution_page_not_found',array(
		'title'	=> __('404 Page Not Found','ecommerce-solution'),
		'panel' => 'ecommerce_solution_panel_id',
	));	
